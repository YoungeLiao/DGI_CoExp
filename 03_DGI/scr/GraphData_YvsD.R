...
write.csv(graph_data, './03_DGI/output_data/graph_data_YvsD_SubCell_dgi.csv', row.names = FALSE)
# baseline dataset
baseline <- graph_data[,1:9]
write.csv(baseline, './03_DGI/output_data/graph_data_YvsD_baseline.csv', row.names = FALSE)
